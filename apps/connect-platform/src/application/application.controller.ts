import { Body, Controller, Delete, Get, HttpStatus, Param, Patch, Post, Put, Query, Req, Res, UseGuards, UsePipes, ValidationPipe } from '@nestjs/common';
...
import {
  ApplicationFilterDto,  GoogleDriveCredentialDto,
  UpdateAppDto
